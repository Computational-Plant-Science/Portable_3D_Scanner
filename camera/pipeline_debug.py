...
def mkdir(path):
    ...
    if not isExists:
        ...
        # if exists, return 
        print('path exists! Overwrite it... \n')
        shutil.rmtree(path)
        os.makedirs(path)
        return False
...
if __name__ == '__main__':
    ...
    #processes = ('mpiexec -host 192.168.1.5 python3 img_capture.py -n 4', 'mpiexec -host 192.168.1.6 python3 img_capture.py -n 4')

    #img_cap_cmd = "python3 img_capture.py -n 3"
    
    #execute_script(img_cap_cmd)
