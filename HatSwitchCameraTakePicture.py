...
Function: test individual camera, code was from online example provided by the camera company

https://github.com/ArduCAM/picamera2_examples/blob/main/HatSwitchCameraTakePicture.py --choose a

USAGE:

    python3 HatSwitchCameraTakePicture 
